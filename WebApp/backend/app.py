...
from controllers.face_video_controller import face_video_ns
...
def create_app():
    ...
    api.add_namespace(face_tracking_ns)
    api.add_namespace(face_recognition_ns)
    api.add_namespace(face_video_ns)
