...
def reconnaissance_personne(dossier_photos="photos"):
    """
    Reconnaît les personnes devant la caméra en utilisant des photos de référence.
    ...
    derniere_detection = {}  # Pour stocker la dernière détection de chaque personne
